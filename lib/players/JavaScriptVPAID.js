...
function JavaScriptVPAID(slot, videoSlot, videoSlotCanAutoplay) {
    VPAID.apply(this, [slot, videoSlot]); // call super()
    this.videoSlotCanAutoplay = videoSlotCanAutoplay || true;
    this.frame = null;
}
    ...
    return new LiePromise(function loadCreative(resolve, reject) {
        ...
        script.onload = function onload() {
            ...
            vpaid.initAd(
                ...
                { slot: slot, videoSlot: video, videoSlotCanAutoPlay: self.videoSlotCanAutoPlay }
            );
        };
